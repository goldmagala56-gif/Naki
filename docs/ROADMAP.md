...
6. [ ] Android app with export on the phone (test on a 2 GB phone first).
7. [ ] Prepare movie screen (convert files that will not play).
8. [ ] Luganda text and a short in-app guide.
9. [ ] Finish v1: all edge cases from the blueprint, test on several phones, release.
